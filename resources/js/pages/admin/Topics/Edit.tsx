...
export default function Edit({ topic, units, onClose, onSuccess }: EditProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        put(`/topics/${topic.id}`, {
            onSuccess: (page: Page<PageProps>) => {
                const updatedTopic = page.props.topics.data[0];
                onSuccess(updatedTopic);
                toast.success('Topic updated successfully');
            },
            onError: (errors) => {
                toast.error('Failed to update topic. Please check the form.');
            }
        });
    };
