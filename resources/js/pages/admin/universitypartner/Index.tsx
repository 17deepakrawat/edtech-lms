    ...
    const handleDelete = (id: number) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                router.delete(`/universitypartner/${id}`, {
                    onSuccess: () => {
                        Swal.fire('Deleted!', 'UniversityPartner has been deleted.', 'success');
                    },
                    onError: () => {
                        Swal.fire('Error!', 'Failed to delete UniversityPartner.', 'error');
                    },
                });
            }
        });
